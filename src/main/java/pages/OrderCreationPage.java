...
public class OrderCreationPage extends DriverClass{
	...
	public void creatingNewRecord( String methodName, String Tc_id) throws Exception, InterruptedException {
		//AccountName.sendKeys(ExcelUtils.readExcel(methodName, Tc_id, "AccountName"));
		AccountName.sendKeys(Test_Date.Datasheet("Order", 1, 1));
		Thread.sleep(3000);
		AccountName.click();
		Acconutlookup.click();
		//ContractNumber.sendKeys(ExcelUtils.readExcel(methodName, Tc_id, "ContractNumber"));
...
public void clickingSavebutton() throws InterruptedException {
	...
	public void verifyCreatedRecord( String methodName, String Tc_id) throws Exception, InterruptedException {
		...
		{ 
			...
			//SeleniumUtils.matchingHighlights( driver,  VerifyContractNumber);
			//Thread.sleep(5000);
		}
		else {
			System.out.println("Failed");
		//	SeleniumUtils.mismatchingHighlights(driver, VerifyContractNumber);
		//	Thread.sleep(5000);
		}
	}
