...
public class AssetPageSteps extends BrowerInvoke {
	...
	public void User007_enters_valid_data() throws Exception {
		...
		Thread.sleep(3000);
		ap2.AssetName.sendKeys(Test_Date.Datasheet("Asset", 1, 0));
		Thread.sleep(3000);
		ap2.AccountClick.sendKeys(Test_Date.Datasheet("Asset", 1, 1));
		Thread.sleep(3000);
		...
		Thread.sleep(3000);
		ap2.ContactClick.sendKeys(Test_Date.Datasheet("Asset", 1, 2));
		Thread.sleep(3000);
